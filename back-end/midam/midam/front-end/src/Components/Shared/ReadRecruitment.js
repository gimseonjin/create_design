...
import CreateApplication from '../Mentor/CreateApplication'
import '../Css/test.css';
import {
    Button,
    Col,
...
const ReadRecruitment = (props) => {
    ...
    const toggleCreateApplication = () => setModalCreateApplication(
    ...
    function setRecruitmentArrays(newArrays) {
        recruitmentArrays = newArrays;
    }
    const renderRecruitmentArrays = (recruitmentArray, index) => {
        ...
        switch (recruitmentArray.recruitmentStatus) {
            case 0:
                statusValue = "모집중";
                ButtonColor = "primary";
                buttonClassName = "createApplication";
                break;
            case 1:
                statusValue = "모집완료";
                break;
        ...
        return (
            <tr key={index}>
                ...
                <td
                    ...
                    onmouseout="this.style.background='blue'">{recruitmentArray.numberOfMentor}</td>
                <td>
                    <Button className={buttonClassName} color={ButtonColor}>{statusValue}</Button>
                </td>
            </tr>
        )
    }
    $(function () {
        ...
        $(".createApplication").off("click")
        $(".createApplication").on("click", function () {
    ...
    function getRecruitment() {
        ...
        axios
            .post('/activity/readRecruitment', form)
            .then((response) => {
